<title>STII Clinic Management System | All Student records</title>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Student records</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body p-3">
                 ...
                 <table id="example1" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM patient WHERE patient.position='Student' ");
                    ...
                    <td>
                        ...
                        <td>
                          <a class="btn btn-primary btn-sm" href="all_student_view.php?student_Id=<?php echo $row['user_Id']; ?>"><i class="fa-solid fa-eye"></i> View</a>
                        </td> 
                    </tr>
