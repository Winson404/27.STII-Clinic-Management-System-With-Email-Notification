              ...
              <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                              <h5 class="text-center mt-2">List of Available Medicines</h5>
                              <hr>
            ...
            <form action="process_update.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Chief complaint</b></span>
                              <textarea cols="30" rows="3" class="form-control" placeholder="Chief complaint" name="chief_complaints" required><?php echo $row['chief_complaints']; ?></textarea>
                            </div>
                        </div>
                ...
                <div class="card-footer">
                  <div class="float-right">
                    <a href="asking_med.php" class="btn bg-secondary"><i class="fa-solid fa-backward"></i> Back to list</a>
                    <button type="submit" class="btn bg-primary" name="update_asking_med" id="create_admin"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                  </div>
                </div>
              </div>
            </form>
