                 ...
                 <table id="example1" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                    ...
                    <tr>
                        ...
                        <td>
                           <a class="btn btn-primary btn-sm" href="teacher_view.php?student_Id=<?php echo $row['patient_Id']; ?>&&asking_med_Id=<?php echo $row['asking_med_Id']; ?>"><i class="fa-solid fa-eye"></i> View</a>
