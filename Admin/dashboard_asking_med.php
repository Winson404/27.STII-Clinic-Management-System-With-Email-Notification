<title>STII Clinic Management System | Today's Asking medicine records</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h3>Today's Asking medicine records</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Today's Asking medicine records</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
