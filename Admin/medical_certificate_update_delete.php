...
<div class="modal fade" id="updateStatus<?php echo $row['req_Id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
       <div class="modal-header bg-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-certificate"></i> Update request medical certificate status</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><i class="fa-solid fa-circle-xmark"></i></span>
        </button>
      </div>
      <div class="modal-body">
        <form action="process_update.php" method="POST">
          <input type="hidden" class="form-control" value="<?php echo $row['req_Id']; ?>" name="req_Id">
          <input type="hidden" class="form-control" value="Medical certificate" name="type">
          <div class="form-group">
            <span class="text-dark"><b>Medical certificate request status</b></span>
