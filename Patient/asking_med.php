            ...
            <div class="card">
              ...
              <div class="card-body p-3">
                 ...
                 <table id="example1" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM asking_med JOIN patient ON asking_med.patient_Id=patient.user_Id WHERE patient.user_Id='$id'");
                    ...
                    <tr>
                        ...
                        <td>
                          <a class="btn btn-info btn-sm" href="asking_med_mgmt.php?page=<?php echo $row['asking_med_Id']; ?>"><i class="fa-solid fa-eye"></i> View</a>
                        </td> 
                    </tr>
