<title>STII Clinic Management System | Consultation records</title>
            ...
            <div class="card">
              ...
              <div class="card-body p-3">
                 ...
                 <table id="example1" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM consultation JOIN patient ON consultation.patient_Id=patient.user_Id WHERE consultation.patient_Id='$id' ");
                    ...
                    <tr>
                        ...
                        <td>
                          <a class="btn btn-info btn-sm" href="consultation_mgmt.php?page=<?php echo $row['consult_Id']; ?>"><i class="fa-solid fa-eye"></i> View</a>
                        </td> 
                    </tr>
