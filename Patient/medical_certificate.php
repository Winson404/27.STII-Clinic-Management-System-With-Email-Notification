            ...
            <div class="card">
              ...
              <div class="card-body p-3">
                 ...
                 <table id="example1" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM request_doc WHERE patient_Id='$id' AND type='Medical Certificate' ");
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <?php else: ?>
                            <button type="button" class="btn bg-info btn-sm" data-toggle="modal" data-target="#update<?php echo $row['req_Id']; ?>" disabled><i class="fas fa-pencil-alt"></i> Edit</button>
                          <?php endif; ?>
