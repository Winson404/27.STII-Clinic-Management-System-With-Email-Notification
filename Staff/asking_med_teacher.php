...
<?php 
    include 'navbar.php'; 
    $req = mysqli_query($conn, "SELECT * FROM request_update WHERE user_Id='$id' AND req_type='Asking Med Teacher' AND req_status=1 ");
?>
            ...
            <div class="card">
              ...
              <div class="card-body p-3">
                 ...
                 <table id="example1" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM asking_med JOIN patient ON asking_med.patient_Id=patient.user_Id WHERE patient.position='Teacher'");
                    ...
                    <tr>
                        ...
                        <td>
                          <a class="btn btn-primary btn-sm" href="teacher_view.php?teacher_Id=<?php echo $row['patient_Id']; ?>&&asking_med_Id=<?php echo $row['asking_med_Id']; ?>"><i class="fa-solid fa-eye"></i> View</a>
                          ...
                          <?php else: ?>
                            <button type="button" class="btn bg-info btn-sm" data-toggle="modal" data-target="#requestupdate_teacher<?php echo $row['asking_med_Id']; ?>"><i class="fas fa-pencil-alt"></i> Request update</button>
                          <?php endif; ?>
