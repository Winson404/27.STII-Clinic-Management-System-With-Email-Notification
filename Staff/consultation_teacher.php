...
<?php 
    include 'navbar.php'; 
    $req = mysqli_query($conn, "SELECT * FROM request_update WHERE user_Id='$id' AND req_type='Consultation Teacher' AND req_status=1 ");
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h3>School Staff Consultation History</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">School Staff Consultation History</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <tbody id="users_data">
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <?php else: ?>
                            <button type="button" class="btn bg-info btn-sm" data-toggle="modal" data-target="#requestupdate_teacher<?php echo $row['consult_Id']; ?>"><i class="fas fa-pencil-alt"></i> Request update</button>
                          <?php endif; ?>
