<title>STII Clinic Management System | Today's Consultation records</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h3>Today's Consultation records</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Today's Consultation records</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
