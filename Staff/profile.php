<title>STII Clinic Management System | Staff profile</title>
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class=" bg-gradient-primary btn-block p-2 rounded text-center">Profile</p>
              </div>
            </div>
                ...
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="viewprofile">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="Email" placeholder="Email" value="<?php echo $row['email']; ?>" readonly style="text-transform: none;">
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="tab-pane" id="updateprofile">
                      ...
                      <div class="form-group row">
                        <label for="email" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="email" name="email" placeholder = "email@gmail.com" required onkeydown="validation()" onkeyup="validation()"  value="<?php echo $row['email']; ?>" style="text-transform: none;">
