              ...
              <div class="card">
                    ...
                    <div class="row">
                       ...
                       <?php 
                        if(isset($_GET['dental'])) {
                          ...
                          $dental_Id = $_GET['dental'];
                          $fetch = mysqli_query($conn, "SELECT * FROM dental JOIN patient ON dental.patient_Id=patient.user_Id WHERE dental.dental_Id='$dental_Id' ORDER BY dental.date_admitted DESC LIMIT 1");
                      ...
                      <?php } } elseif(isset($_GET['medical'])) {
                        $form2_Id = $_GET['medical'];
                        $fetch = mysqli_query($conn, "SELECT * FROM form2 JOIN patient ON form2.patient_Id=patient.user_Id WHERE form2.form2_Id='$form2_Id' ORDER BY form2.date_admitted DESC LIMIT 1");
                        if(mysqli_num_rows($fetch) > 0) {
                          $row = mysqli_fetch_array($fetch);
                      ?>
                      ...
                      ?>
                        ...
                        <div class="col-lg-12 mt-3 mb-2">
                          <a class="h5 text-bold text-primary">PHYSICAL EXAMINATION</a>
                          <div class="dropdown-divider"></div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                      ...
                      <?php } } elseif(isset($_GET['consult_Id'])) {
                      ...
                      ?>
                        <div class="col-lg-12 mt-3 mb-2">
                          <a class="h5 text-bold text-primary">CONSULTATION RECORDS</a>
                          <div class="dropdown-divider"></div>
                        </div>
                        <div class="col-12">
                          <div class="form-group">
                ...
                <div class="card-footer">
                  <div class="float-right">
                    ...
                    <!-- <a href="teacher_update.php?teacher_Id=<?php echo $teacher_Id; ?>" class="btn bg-info"><i class="fas fa-pencil-alt"></i> Edit</a> -->
                  </div>
                </div>
              </div>
            </form>
