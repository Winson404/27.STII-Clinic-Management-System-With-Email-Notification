<title>STII Clinic Management System | Register</title>
          ...
          <form action="processes.php" method="POST" enctype="multipart/form-data">
            <div class="card card-outline card-primary">
              <div class="card-header text-center">
                <a href="#" class="h2"><b>STII School Clinic Registration</b></a>
                <br>
                <a href="#" class="h5 text-muted"><b>Medical Form</b></a>
              </div>
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12" id="grade">
                    <div class="form-group">
                      <span class="text-dark"><b>Year/Course</b></span>
                      <input type="text" class="form-control"  placeholder="Enter Year/course" name="grade">
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12" id="position" style="display:none">
                    <div class="form-group">
