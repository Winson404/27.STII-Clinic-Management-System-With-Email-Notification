<title>STII Clinic Management System | Send verification code</title>
...
?>
 ...
 <?php } elseif(isset($_GET['patient_Id'])) { 
      ...
      $fetch = mysqli_query($conn, "SELECT * FROM patient WHERE user_Id='$patient_Id'");
      $row = mysqli_fetch_array($fetch);
  ?> 
        ...
        <div class="card card-outline card-primary mt-3">
          ...
          <div class="card-body">
            ...
            <form action="processes.php" method="POST">
              ...
              <input type="hidden" class="form-control mb-3" name="email" value="<?php echo $row['email']; ?>">
              <input type="hidden" class="form-control mb-3" name="patient_Id" value="<?php echo $patient_Id; ?>">

              <div class="row">
                <div class="col-md-12">
                  <div class="input-group mb-3">
                    <img src="images-users/<?php echo $row['picture']; ?>" alt="" style="width: 60px;height: 60px; border-radius: 50%; display: block;margin-left: auto;margin-right: auto;margin-bottom: -12px;">
                  </div>
                  <p class="text-center mb-4"><?php echo $row['name']; ?></p>
                </div>
              ...
              <div class="row">
                <div class="col-12">
                  <button type="submit" class="btn bg-gradient-primary btn-block"  name="sendcode_patient">Continue</button>
                  <p class="mt-1"><a href="forgot-password.php" class="text-center">Not you?</a></p>  
                </div>
              </div>
            </form>
