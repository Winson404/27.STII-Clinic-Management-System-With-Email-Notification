<title>STII Clinic Management System | Verify code</title>
...
<?php } elseif(isset($_GET['patient_Id']) && isset($_GET['email'])) {
        ...
        <div class="col-lg-4 mt-5">
          <div class="card card-outline card-primary mt-5">
            ...
            <div class="card-body">
              <p class="login-box-msg">Please check your email for a message with your code. Your code is 6 numbers long.</p>
              <form action="processes.php" method="post">
                <input type="hidden" class="form-control mb-3" value="<?php echo $patient_Id; ?>" name="patient_Id">
                <input type="hidden" class="form-control mb-3" value="<?php echo $email; ?>" name="email">
                <div class="input-group mb-3">
                  <input type="number" class="form-control" placeholder="Enter verification code" name="code" minlength="6" maxlength="6" required>
                  <div class="input-group-append">
                ...
                <div class="row">
                  <div class="col-12">
                    <button type="submit" class="btn bg-gradient-primary btn-block"  name="verify_code_patient">Continue</button>
                    <a href="sendcode.php?patient_Id=<?php echo $patient_Id; ?>" class="mt-1">Didn't get a code?</a>
                  </div>
                </div>
              </form>
              <p class="mt-3 mb-1">
